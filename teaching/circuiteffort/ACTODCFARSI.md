...
**فصل 6: طراحی و شبیه‌سازی مبدل‌های AC به DC را بررسی می‌کند**
...
### رگولاتورها
پس از یک‌سوسازی، خروجی DC را می‌توان با استفاده از رگولاتورها بیشتر تثبیت کرد که عمدتاً دو نوع هستند:
...
<div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/assets/circuiteffort/ACTODC/LinearRegulator_1.PNG" alt="شماتیک رگولاتور خطی" style="width: 50%; height: 50%; object-fit: contain;">
</div>
...
<div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/assets/circuiteffort/ACTODC/LinearReg_2.PNG" alt="رگولاتور خطی با تقویت کننده تفاضلی" style="width: 50%; height: 50%; object-fit: contain;">
</div>
...
<div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/assets/circuiteffort/ACTODC/LM317_LinearRegulator.PNG" alt="رگولاتور خطی LM317" style="width: 50%; height: 50%; object-fit: contain;">
</div>


### دیود محافظ

#### دیود محافظ برای محدود کردن ولتاژ امیتر-بیس

<div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/assets/circuiteffort/ACTODC/ProtectVBE_Trans_BJT_N.PNG" alt="دیود محافظ برای ولتاژ امیتر-بیس" style="width: 50%; height: 50%; object-fit: contain;">
</div>

#### دیودها می‌توانند برای محدود کردن ورودی OPAMP به 0.7V استفاده شوند

<div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/assets/circuiteffort/ACTODC/OpAmp_Protect_Input.PNG" alt="محافظت ورودی Op-Amp با دیودها" style="width: 50%; height: 50%; object-fit: contain;">
</div>

#### بیمه قطبی (POLARITY INSURANCE)

<div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/assets/circuiteffort/ACTODC/POLARITYINSURANCE.PNG" alt="مدار بیمه قطبی" style="width: 50%; height: 50%; object-fit: contain;">
</div>

#### رله با مدار دیود
یک مدار رله از سه جزء کلیدی تشکیل شده است: سوئیچ‌ها، سیم پیچ رله و یک دیود. سوئیچ‌ها اتصال الکتریکی قابل اطمینان بدون نویز را تضمین می‌کنند، در حالی که سیم پیچ رله سوئیچینگ بین حالت‌های باز و بسته را کنترل می‌کند. دیود سرکوب ولتاژ گذرا را فراهم می‌کند و از مدار سوئیچینگ در برابر اسپایک‌های ولتاژ ناشی از فعال‌سازی و غیرفعال‌سازی رله محافظت می‌کند.

<div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/assets/circuiteffort/ACTODC/Basicrelaywithdiodecircuit.PNG" alt="مدار رله پایه با دیود" style="width: 50%; height: 50%; object-fit: contain;">
</div>
...
<div style="display: flex; justify-content: center; align-items: center; gap: 10px;">
    <img src="/assets/circuiteffort/ACTODC/1.png" alt="مدار رله پایه با دیود" style="width: 50%; height: 50%; object-fit: contain;">
</div>
